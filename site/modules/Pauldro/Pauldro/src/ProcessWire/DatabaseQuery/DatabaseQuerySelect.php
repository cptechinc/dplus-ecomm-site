...
/**
 * Pauldro\ProcessWire DatabaseQuerySelect
 *
 * A wrapper for SELECT SQL queries.
 * 
 * NOTE: This allows connecting to different Databases by the database() function
 *
 ...
 *
 */
class DatabaseQuerySelect extends AbstractDatabaseQuery {
