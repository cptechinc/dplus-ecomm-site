...
/**
 * WireCache
 * Extends WireCache for functionality
 */
class WireCache extends PwWireCache {
	...
	/**
	 * Return if cache exists in namespace
	...
	/**
	 * Return the number of Cache records that match $name
	 * @param  string         $name
	 * @param  string|null    $expire
	 * @param  callable|null  $func
	 * @return mixed|null
	...
	/**
	 * Return the number of Cache records that match $name in $namespace
	 * @param  string         $ns    Namespace
	 * @param  string         $name
	 * @param  string|null    $expire
	 * @param  callable|null  $func
