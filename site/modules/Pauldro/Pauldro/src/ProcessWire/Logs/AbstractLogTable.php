...
// Pauldro ProcessWire
use Pauldro\ProcessWire\DatabaseTables\AbstractDatabaseTable;
 ...
 */
abstract class AbstractLogTable extends AbstractDatabaseTable {
	const TABLE = '';
	const FORMAT_DATETIME = 'Y-m-d H:i:s';
	const COLUMNS = [];
	const PRIMARYKEY = [];
	const MODEL_CLASS = '\\Pauldro\\ProcessWire\\Logs\\LogEntry';
