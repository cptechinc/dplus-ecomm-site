...
============================================================= */	
	 ...
	 * @return bool
	 */
	protected static function create(WireData $data) {
...
============================================================= */
	 ...
	 * @return bool
	 */
	protected static function update(Page $p, WireData $data) {
		$p->of(false);
		static::setSimpleFields($p, $data);
		static::setExtraFields($p, $data);
	 ...
	 * @return void
	 */
	protected static function setSimpleFields(Page $p, WireData $data) {
		foreach (static::getPageSimpleFields() as $fieldName) {
	 ...
	 * @return void
	 */
	protected static function setExtraFields(Page $p, WireData $data) {
