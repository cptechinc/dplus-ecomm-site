...
// App
use App\Ecomm\PageInstallers\Products as PagesInstaller;
use App\Ecomm\PageManagers\ProductsManager as PageRepo;
use App\Ecomm\Pages\Templates\Product as Template;

class Products extends AbstractController {
	const SESSION_NS = 'admin-products';
    ...
    public static function index(WireData $data) {
		...
		self::initPageHooks();
        self::pw('page')->title = "Product Pages";
...
============================================================= */
	private static function renderList(WireData $data, PageArray $list) {
		return self::getTwig()->render('admin/pages/products/page.twig', ['list' => $list]);
	}
