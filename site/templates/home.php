<?php include ('./_head.php'); ?>
	<div class="mb-4 main">
	<section style="background: url('<?= $urls->files . 'test/'; ?>photogrid.jpg') center center repeat; background-size: cover;" class="relative-positioned">
        <!-- Carousel Start-->
            ...
            <div class="homepage owl-carousel">
              <div class="item">
                <div class="row">
                  <div class="col-md-5 text-right">
                    <p><img src="<?= $urls->files . 'test/'; ?>logo.png" alt="" class="ml-auto"></p>
                    <h1>Multipurpose responsive theme</h1>
                    <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                  </div>
                  <div class="col-md-7"><img src="<?= $urls->files . 'test/'; ?>template-homepage.png" alt="" class="img-fluid"></div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-md-7 text-center"><img src="<?= $urls->files . 'test/'; ?>template-mac.png" alt="" class="img-fluid"></div>
                  <div class="col-md-5">
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-md-7"><img src="<?= $urls->files . 'test/'; ?>template-easy-customize.png" alt="" class="img-fluid"></div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-md-7"><img src="<?= $urls->files . 'test/'; ?>template-easy-code.png" alt="" class="img-fluid"></div>
                  <div class="col-md-5">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row portfolio-showcase">
                <div class="col-md-6">
                  <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-4.jpg" alt="" class="img-fluid"></div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row portfolio text-center no-space">
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-1.jpg" alt="" class="img-fluid">
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-2.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-3.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-4.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-5.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-6.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-7.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-9.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?= $urls->files . 'test/'; ?>portfolio-8.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
      ...
      <section class="bar bg-gray">
        <div class="container">
          <ul class="list-unstyled owl-carousel customers no-mb">
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-1.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-2.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-3.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-4.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-5.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="<?= $urls->files . 'test/'; ?>customer-6.png" alt="" class="img-fluid"></li>
          </ul>
        </div>
      </section>
	</div>
